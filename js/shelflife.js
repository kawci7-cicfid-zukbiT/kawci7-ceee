...
function renderShelfLife() {
  ...
  <div style="display:flex;gap:0.4rem;align-items:center">
    ...
    <button type="button" onclick="SL._autoCalcEa()" 
      title="Calculate Ea automatically from laminate"
      style="white-space:nowrap;padding:0.55rem 0.6rem;border:1.5px solid var(--border);border-radius:6px;background:#fff;font-size:0.75rem;cursor:pointer;color:var(--primary);font-weight:600">
      Auto Ea
    </button>
  </div>
</div>
