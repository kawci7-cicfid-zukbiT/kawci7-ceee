...
function _ppwrMethodology() {
  return '<div class="card" style="margin-top:1rem;border-left:4px solid var(--primary);background:var(--card)">' +
    ...
    '<h3 style="font-family:Georgia,\'Times New Roman\',serif;font-size:1rem;color:var(--text);margin:1.2rem 0 0.4rem">What the material code means</h3>' +
    ...
    '<h3 style="font-family:Georgia,\'Times New Roman\',serif;font-size:1rem;color:var(--text);margin:1.2rem 0 0.4rem">How the tool decides the code</h3>' +
    '<p style="margin:0 0 1rem">Most laminates contain more than one material, so the tool has to decide which ones really count. It does this by weight. A material family is counted only if it makes up more than 5% of the total weight; anything smaller is treated as a minor component and set aside. If more than one family passes that 5% line, the pack is a composite, and the code follows fixed rules: plastic + aluminium gives <strong>90</strong>, paper + plastic gives <strong>81</strong>, paper + aluminium <strong>82</strong>, and paper + plastic + aluminium 84.</p>' +
 
    '<h3 style="font-family:Georgia,\'Times New Roman\',serif;font-size:1rem;color:var(--text);margin:1.2rem 0 0.4rem">How the weights are found</h3>' +
    ...
    '<h3 style="font-family:Georgia,\'Times New Roman\',serif;font-size:1rem;color:var(--text);margin:1.2rem 0 0.4rem">How recyclability is judged</h3>' +
    ...
    '<h3 style="font-family:Georgia,\'Times New Roman\',serif;font-size:1rem;color:var(--text);margin:1.2rem 0 0.4rem">Substances of concern (including PFAS)</h3>' +
    ...
    '<h3 style="font-family:Georgia,\'Times New Roman\',serif;font-size:1rem;color:var(--text);margin:1.2rem 0 0.4rem">The dates that matter</h3>' +
